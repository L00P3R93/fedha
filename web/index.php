...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .ftco{width: 100%; height: 30vh;}
            .flati{width: 50px !important; height: 50px; margin: 0 auto;}
            .flati-close{width: 30px !important; height: 30px;}
            .scrollToTopBtn {background-color: black;border: none;border-radius: 50%;color: white;cursor: pointer;font-size: 16px;line-height: 48px;width: 48px;position: fixed;bottom: 50px;right: 30px;z-index: 100;opacity: 0;transform: translateY(100px);transition: all .5s ease}
            .showBtn {opacity: 1;transform: translateY(0)}
            #feedback {float: left;position: fixed;top: calc(50% - 47px);right: 0;z-index: 1000;}
            #feedback a {background: #0072bc;border-radius: 5px 0 0 5px;box-shadow: 0 0 3px rgba(0, 0, 0, .3);border: 3px solid #fff;border-right: 0;display: block;padding: 20px 12px;transition: all .2s ease-in-out;}
        ...
        <div class="site-wrap" id="home-section">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="#" class=""><span class="mr-2 icon-phone"></span> <span class="d-none d-md-inline-block">+254 712 345 678</span></a>
                            <div class="float-right">
                                <a href="#" class=""><span class="mr-2 icon-twitter"></span></a>
                                <span class="mx-md-2 d-inline-block"></span>
                                <a href="#" class=""><span class="mr-2 icon-facebook"></span></a>
                                <span class="mx-md-2 d-inline-block"></span>
                                <a href="#" class=""><span class="mr-2 icon-instagram"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
                <div class="container">
                    <div class="row align-items-center position-relative">
                        <div class="site-logo">
                            <a href="index" class="text-black"><span class="text-primary">Fedha</a>
                        </div>
                        <div class="col-12">
            ...
            <div class="ftco-blocks-cover-1">
                <div class="owl-carousel slide-one-item">
                    <div class="ftco-cover-1 overlay" style="background-image: url('assets/images/fedha/001.jpg')">
                        <div class="container">
                            <div class="row align-items-center justify-content-center text-center">
                                <div class="col-lg-12">
                                    <h1>Vestibulum rutrum ipsum a lorem ultricies, et pharetra mi ultricies.</h1>
                                    <p class="mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus dolorem eius eligendi esse quod?</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="ftco-cover-1 overlay" style="background-image: url('assets/images/fedha/010.jpg')">
                        <div class="container">
                            <div class="row align-items-center justify-content-center text-center">
                                <div class="col-lg-12">
                                    <h1>Proin pharetra ligula nec augue elementum efficitur.</h1>
                                    <p class="mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus dolorem eius eligendi esse quod?</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="ftco-cover-1 overlay" style="background-image: url('assets/images/fedha/008.jpg')">
                        <div class="container">
                            <div class="row align-items-center justify-content-center text-center">
                                <div class="col-lg-12">
                                    <h1>Nunc dignissim arcu a lectus condimentum finibus.</h1>
                                    <p class="mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus dolorem eius eligendi esse quod?</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="site-section ftco-service-image-1 pb-5">
                    <div class="container">
                        <div class="owl-carousel owl-all-2">
                            <div class="service text-center">
                                <a href="#"><img src="assets/images/fedha/005.jpg" alt="Image" class="img-fluid ftco"></a>
                                <div class="px-md-3">
                                    <h3><a href="#">Vestibulum suscipit.</a></h3>
                                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Beatae distinctio laudantium nulla eos numquam incidunt!</p>
                                </div>
                            </div>
                            <div class="service text-center">
                                <a href="#"><img src="assets/images/fedha/003.jpg" alt="Image" class="img-fluid ftco"></a>
                                <div class="px-md-3">
                                    <h3><a href="#">Maecenas tincidunt.</a></h3>
                                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Beatae distinctio laudantium nulla eos numquam incidunt!</p>
                                </div>
                            </div>
                            <div class="service text-center">
                                <a href="#"><img src="assets/images/fedha/011.jpg" alt="Image" class="img-fluid ftco"></a>
                                <div class="px-md-3">
                                    <h3><a href="#">Nam sed nibh rhoncus.</a></h3>
                                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Beatae distinctio laudantium nulla eos numquam incidunt!</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row mb-5 justify-content-center">
                        <div class="col-md-12 text-center">
                            <p class="block-heading-1" data-aos="fade-up" data-aos-delay="">
                                <h2>About Us</h2>
                        ...
                        <div class="col-md-12 mb-5">
                            <figure class="block-img-video-1" data-aos="fade">
                                <a href="#" data-fancybox data-ratio="2">
                                    ...
                                    <img src="assets/images/fedha/009.jpg" alt="Image" class="img-fluid">
                                </a>
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="row pt-5 mt-5 text-center">
                        <div class="col-md-12">
                            <div class="border-top pt-5">
                                <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Fedha Electronics</a></p>
                            </div>
                        </div>
